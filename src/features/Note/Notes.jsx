...
function Notes() {
  ...
  return (
    <>
      <div className="h-full lg:p-4  lg:grid grid-flow-col grid-cols-[1fr,2fr] gap-4 pb-12 p-4">
        <div className="overflow-y-scroll shrink h-full flex flex-col  gap-2 ">
          <FolderDropdown />
          <NoteList notes={notes} />
        </div>
        <div className="hidden bg-white rounded-xl lg:flex flex-col p-6">
