...
function Sidebar() {
  return (
    <div className="h-fit bottom-0 w-max place-self-center m-3 lg:m-0 lg:h-full lg:w-full absolute lg:static  lg:grid grid-flow-col bg-gray-100 border-r-2 border-gray-300 rounded-2xl ring-2 ring-gray-300 shadow-xl lg:shadow-none lg:ring-0 lg:rounded-none">
      <div>
        <Logo />
