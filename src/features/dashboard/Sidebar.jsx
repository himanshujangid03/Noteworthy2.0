...
function Sidebar() {
  return (
    <div className="h-fit bottom-0 w-max place-self-center m-3 lg:m-0 lg:h-full lg:w-full absolute lg:static  lg:grid grid-flow-col bg-base-100 border-gray-300 rounded-2xl ring-2 ring-gray-300 shadow-xl lg:shadow-none lg:ring-0 lg:rounded-none">
      <div>
        <Logo />
        <MotionUl className="menu menu-horizontal lg:menu-vertical lg:mt-10 lg:gap-2">
          <ListItem to={"/"} datatip="Dashboard">
            <CiGrid41 className=" lg:size-7 size-6 " />
          </ListItem>
