...
function Sidebar() {
  return (
    <div className="h-fit z-50 lg:pl-2 bottom-0 w-full place-self-center lg:m-0 lg:h-full lg:w-full absolute lg:static bg-gray-50 lg:bg-base-100 border-gray-300 ring-2 ring-gray-300 shadow-xl lg:shadow-none lg:ring-0 lg:rounded-none">
      <div>
        <Logo />
